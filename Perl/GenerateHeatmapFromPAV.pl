...
system("ulimit -s 163840;Rscript R/heatmap.R -f $heatmap.accessory_01matrix.txt -o $heatmap.complete.svg");
...
system("Rscript R/upsetr.R $heatmap.upsetr.txt $heatmap.upsetr.pdf $nb_strains");
